"""
This implementation was adapted from https://github.com/openai/baselines
"""
...
class PrioritizedReplayBuffer(BaseBuffer):
    ...
    def add(self, obs: np.ndarray, next_obs: np.ndarray, action: np.ndarray, next_action: np.ndarray,
